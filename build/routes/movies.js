...
var movie_1 = __importStar(require("../models/movie"));
...
router.get("/", auth_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, movie_1.default.find().sort("name")];
            case 1:
                moives = _a.sent();
                return [2 /*return*/, res.send(moives)];
        }
    });
}); });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, genre_1.default.findById(req.body.genreId)];
            case 1:
                genre = _a.sent();
                if (!genre)
            ...
            case 2:
                _a.sent();
                return [2 /*return*/, res.send(movie)];
        }
    });
}); });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!genre)
                    res.status(400).send("Invalid genre");
                return [4 /*yield*/, movie_1.default.findByIdAndUpdate(req.params.id, {
                        title: req.body.title,
                        genre: genre,
                        dailyRentalRate: req.body.dailyRentalRate,
                        numberInStock: req.body.numberInStock,
...
router.delete("/:id", auth_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, movie_1.default.findByIdAndRemove(req.params.id)];
            case 1:
                movie = _a.sent();
                if (!movie)
                    res.status(404).send("the movie with the given ID was not found");
...
router.get("/:id", auth_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, movie_1.default.findById(req.params.id)];
            case 1:
                movie = _a.sent();
                if (!movie)
                    res.status(404).send("the movie with the given ID was not found");
