...
var customer_1 = __importStar(require("../models/customer"));
var router = express_1.default.Router();
router.get("/", auth_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var customers;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, customer_1.default.find().sort("name")];
            case 1:
                customers = _a.sent();
...
router.post("/", auth_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                error = (0, customer_1.validateCustomer)(req.body).error;
                if (error)
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (error)
                    return [2 /*return*/, res.status(400).send(error.details[0].message)];
                return [4 /*yield*/, customer_1.default.findByIdAndUpdate(req.params.id, {
                        name: req.body.name,
                        phone: req.body.phone,
                    }, { new: true })];
            case 1:
...
router.delete("/:id", auth_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, customer_1.default.findByIdAndRemove(req.params.id)];
            case 1:
                customer = _a.sent();
                if (!customer)
                    res.status(404).send("the customer with the given ID was not found");
...
router.get("/:id", auth_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, customer_1.default.findById(req.params.id)];
            case 1:
                customer = _a.sent();
                if (!customer)
                    res.status(404).send("the customer with the given ID was not found");
