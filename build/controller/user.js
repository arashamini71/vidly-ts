...
exports.register = exports.getCurrent = void 0;
var user_1 = __importStar(require("../models/user"));
var userServie = __importStar(require("../services/user"));
...
function getCurrent(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, userServie.getById(req.body.userId)];
                case 1:
                    user = _a.sent();
                    return [2 /*return*/, res.send(lodash_1.default.pick(user, ["_id", "name", "email"]))];
            }
        });
    });
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, userServie.create(req.body)];
                case 2:
                    user = _a.sent();
