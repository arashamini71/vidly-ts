...
UserSchema.methods.generateAuthToken = function () {
    var _a;
    var JWT_SECRET = (_a = process.env.JWT_SECRET) !== null && _a !== void 0 ? _a : "JWT_SECRET";
    var token = jsonwebtoken_1.default.sign({ sub: this._id, name: this.name, isAdmin: this.isAdmin }, JWT_SECRET);
    return token;
};
